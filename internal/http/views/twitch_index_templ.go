...
func TwitchIndex() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<main class=\"flex-1 bg-gray-100 dark:bg-gray-950 py-12\"><div class=\"container mx-auto px-4\"><div>Twitch Stuff</div><form action=\"/api/services/twitch/chat\" method=\"post\"><button type=\"submit\">Enable Chat Service</button></form><form action=\"/api/services/twitch/chat\" method=\"delete\"><button type=\"submit\">Disable Chat Service</button></form></div></main>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
